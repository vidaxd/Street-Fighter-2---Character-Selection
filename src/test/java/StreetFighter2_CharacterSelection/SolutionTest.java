...
import es.ulpgc.StreetFighter2_CharacterSelection.Solution;
...
public class SolutionTest {
    ...
    public void shouldWorkWithNoMoves() {
        ...
        Assert.assertEquals(solution, Solution.streetFighterSelection(fighters, new int[]{0,0}, new String[]{}));
    }
